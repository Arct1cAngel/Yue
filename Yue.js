  ...
  switch(interaction.commandName) {
    ...
    case "kill":
      ...
      await client.users.cache.get(Target.id).send(":boom: :gun: You're dead :)").catch(async error => {
        await interaction.user.send("They've got barracades, I can't break through. I'm sorry to have failed you, boss. (This user has blocked me or has dms turned off)")
        DmAble = false;
        return;
        }).catch(async error => {
